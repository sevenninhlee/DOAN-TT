...
class StampsController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $scheck = Stamp::where("user_id", $user_id->client->id)->where("default", 1)->count();
      ...
      $url = env('APP_URL', 'http://localhost:8000') . "/images/" . $stamp->uploaded_url;
      $stamp->uploaded_url = $url; 
    ...
    {
      // Remove user's other default stamp
      $user_id = User::with('client')->find(Auth::id());
