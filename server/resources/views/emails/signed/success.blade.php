		...
		<div class="content-card">
			<div class="doc-format" style="border-color: rgb(46, 57, 73);">
				...
				<div class="doc-content">
					<div class="doc-title">Your document has been completed</div>
					<div class="text-center mt-3 mb-4">
						Press button below to view completed document.
					</div>
					...
					<button type="button" class="btn mt-4 btn-secondary btn-block" style="background-color: rgb(98, 153, 248); color: #fff;"><a href='{{ $info['url_document'] }}' style="text-decoration: none; color: #fff;">View completed document</a></button>
				</div>
			</div>
			<div class="doc-content">
