...
var script = {
  ...
  computed: {
    flagIconClass: function flagIconClass () {
      ...
      return ( obj = {}, obj[("flag " + (this.flagIconCountry))] = true, obj[this.flagMargin] = true, obj )
    },
...
var __vue_staticRenderFns__ = [];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-05fb4d45_0", { source: ".small-flag[data-v-05fb4d45]{margin:-24px;transform:scale(.25);-ms-transform:scale(.25);-webkit-transform:scale(.25);-moz-transform:scale(.25)}.normal-flag[data-v-05fb4d45]{margin:-16px;transform:scale(.5);-ms-transform:scale(.5);-webkit-transform:scale(.5);-moz-transform:scale(.5)}.big-flag[data-v-05fb4d45]{margin:0;transform:scale(1);-ms-transform:scale(1);-webkit-transform:scale(1);-moz-transform:scale(1)}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-05fb4d45";
  /* module identifier */
  var __vue_module_identifier__ = "data-v-05fb4d45";
  /* functional template */
...
function install(Vue) {
  ...
  Vue.component('CountryFlag', component);
}
