...
.email-app .toolbar .btn:hover {
  background-color: #343b41;
}

.email-app .toolbar .dropdown-menu.show {
  background-color: #2f353a;
}

.email-app .toolbar .dropdown-item:active {
  color: #e4e7ea;
  background-color: #3a4149;
}

.email-app .toolbar .dropdown-item:hover {
  color: #e4e7ea;
  background-color: #343b41;
}

.email-app .form-control {
  border-color: #343b41;
}
